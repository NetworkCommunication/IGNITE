...
class ENV_gk_dqn:
    def __init__(self, num_car, num_task, num_bs):
        ...
        self.num_tcar = num_task
        self.num_scar = num_car - self.num_tcar
    ...
    def step(self, action):
        ...
        get4 = 1
        if get1 == 1:
            get2 = int(action * (self.num_scar + self.num_bs) / 100) + 1
            if get2 == 0:
                get2 = 1
            get3 = int(action / 10)
        ...
        if get1 == 0 or get3 == 0:
            ...
            is_bs = False
            if get2 >= (self.num_scar + self.num_bs):
                f_general = self.bs[0].fn_bs
                is_bs = True
            else:
                f_general = self.car[self.num_scar + get2 - 1].fn
